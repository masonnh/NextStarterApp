    ...
    >
      <div className="grid gap-4 md:grid-cols-3">
        {testimonials.items.map((item) => (
          <Card key={item.name} className="border-slate-200 bg-white/90 shadow-sm dark:border-slate-700 dark:bg-slate-900/80">
            <CardHeader>
              ...
              <CardTitle className="text-base text-slate-900 dark:text-slate-100">{item.name}</CardTitle>
            </CardHeader>
            <CardContent>
