  ...
  return (
    <div>
      ...
      <section>
        ...
        <p>
          We provide a software-as-a-service platform. The service is provided
          "as is" and may be modified, updated, or discontinued at any time
          without notice.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          All payments are non-refundable. We reserve the right to change our
      ...
      <section>
        ...
        <p>
          ...
          not limited to text, graphics, logos, and software, are owned by us
